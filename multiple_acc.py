...
# ────────────────────────────────────────────────
ACCOUNTS = [
    {"id": 1,  "api_id": int(os.getenv("API_ID"))int(os.getenv("API_ID")), "api_hash": os.getenv("API_HASH"), "session": "checker_01"},
    {"id": 2,  "api_id": int(os.getenv("API_ID"))int(os.getenv("API_ID")), "api_hash": os.getenv("API_HASH"), "session": "checker_02"},
    {"id": 3,  "api_id": int(os.getenv("API_ID"))int(os.getenv("API_ID")), "api_hash": os.getenv("API_HASH"), "session": "checker_03"},
    # {"id": 4,  "api_id": int(os.getenv("API_ID"))int(os.getenv("API_ID")), "api_hash": os.getenv("API_HASH"), "session": "checker_04"},
    # {"id": 5,  "api_id": int(os.getenv("API_ID"))int(os.getenv("API_ID")), "api_hash": os.getenv("API_HASH"), "session": "checker_05"},
    # {"id": 6,  "api_id": int(os.getenv("API_ID"))int(os.getenv("API_ID")), "api_hash": os.getenv("API_HASH"), "session": "checker_06"},
    # {"id": 7,  "api_id": int(os.getenv("API_ID"))int(os.getenv("API_ID")), "api_hash": os.getenv("API_HASH"), "session": "checker_07"},
    # {"id": 8,  "api_id": int(os.getenv("API_ID"))int(os.getenv("API_ID")), "api_hash": os.getenv("API_HASH"), "session": "checker_08"},
    # {"id": 9,  "api_id": int(os.getenv("API_ID"))int(os.getenv("API_ID")), "api_hash": os.getenv("API_HASH"), "session": "checker_09"},
    # {"id": 10, "api_id": int(os.getenv("API_ID"))int(os.getenv("API_ID")), "api_hash": os.getenv("API_HASH"), "session": "checker_10"},
]
